...
const MorphingIcon = ({ type, isActive, onClick, onMouseEnter }: { type: string, isActive: boolean, onClick: () => void, onMouseEnter?: () => void }) => {
    ...
    if (type === 'home') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("home", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
    ...
    if (type === 'blog') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("blog", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
    ...
    if (type === 'marker') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("marker", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
    ...
    if (type === 'email') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("email", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
    ...
    if (type === 'linkedin') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("linkedin", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
    ...
    if (type === 'x') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("x", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
    ...
    if (type === 'github') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("github", isActive ? "active text-neutral-900 dark:text-white" : "text-neutral-500 dark:text-neutral-400")}>
                <svg viewBox="0 0 24 24" className="h-[22px] w-[22px] fill-current">
            ...
            >
                <div
                    className={cn(
                        ...
                        "border border-black/10 bg-white/80 dark:border-white/15 dark:bg-black/80",
