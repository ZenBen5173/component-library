...
export function AnimatedFooter({
  ...
  cellSize = 20,
  fontSize = 18,
  parallaxStrength: parallaxStrengthProp = 20,
  hoverRadius = 8,
  revealOnScroll = true,
  revealed,
  className,
  ...
  // Pin the artwork instead of drifting it with the pointer.
  const parallaxStrength = reducedMotion ? 0 : parallaxStrengthProp;
