            ...
            >
                ...
                {mounted &&
                    tiles.map((_, i) => (
                        <div
                            key={i}
                            className="tile min-h-[1px] min-w-[1px] border border-gray-300 bg-transparent transition-colors duration-[1500ms] hover:bg-gray-400/70 hover:duration-0 dark:border-gray-700 dark:hover:bg-gray-400/60"
                        />
                    ))}
            </div>
